...
class PurchaseInvestmentAccounting(object):
    """
    ...
    def purchase_investment(self, document_header=None, document_detail=None, decimal_value=None,
        ...
        # accountingRecord.AllThird = detail.Provider.ProviderId;
    ...
    def detail_iva(self, document_header=None, document_detail=None, overcost=None, discount=None,
        ...
        if not document_header.overCostTaxBase and \
            not (document_detail.item and document_detail.item.disccountToUnitValue):

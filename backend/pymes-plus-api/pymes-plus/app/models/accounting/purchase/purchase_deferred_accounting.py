# coding=utf-8
#########################################################
# Purchase Deferred Accounting module
# Date: 29-11-2016
#########################################################
...
class PurchaseDeferredAccounting(object):
    """
    ...
    def purchase_deferred(self, document_header, document_detail, decimal_value, account_type="D"):

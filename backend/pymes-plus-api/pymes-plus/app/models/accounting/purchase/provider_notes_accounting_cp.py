...
class ProviderNoteAccountingCP(object):
    """
    ...
    def do_account(self, document_header=None, document_details=None, payment_receipt =None):
        ...
        """
        try:
            if document_header.sourceDocumentHeader.source.shortWord == 'FP':
                ...
                if self.total_records > 0:
                    ...
                    for detail in document_details:
                        ...
                        self.discount2 = 0 if document_header.subtotal == 0 else _round(
                            document_header.disccount2Value * (detail.value / document_header.subtotal), self.round_decimals)
                        ...
                        # Inventario
                            ...
                            if detail.sourceDocumentDetail is None or \
                                    (detail.sourceDocumentDetail and (
                                            detail.sourceDocumentDetail.documentHeader.documentType is None
                                    or (detail.sourceDocumentDetail.documentHeader.documentType and
                                            ...
                                            not (
                                                    document_header.sourceDocumentType.shortWord == "OP" and document_header.source.shortWord == "FRP")))):
                                ...
                                elif (detail.sourceDocumentDetail and (
                                    detail.sourceDocumentDetail.documentHeader.documentType and
            ...
            elif document_header.sourceDocumentHeader.source.shortWord == 'FRP':
                # Almacena el numero de registros que hay en el document details
                if document_details and len(document_details):
                    self.total_records = len(document_details)
                    ...
                    for detail in document_details:
                        ...
                        # Inventario
                            ...
                            if detail.sourceDocumentDetail is None or \
                                    ...
                                    or (detail.sourceDocumentDetail.documentHeader.documentType and
                                            not (
                                                    detail.sourceDocumentDetail.documentHeader.documentType.shortWord == "RP" or
                                                    detail.sourceDocumentDetail.documentHeader.documentType.shortWord == "FRP") and
                                            not (
                                                    document_header.sourceDocumentType.shortWord == "OP" and document_header.source.shortWord == "FRP")))):
                ...
                if self.total_records > 0:
                    ...
                    for detail in document_details:
                        ...
                        # los detalles
                        self.overcost = 0 if document_header.subtotal == 0 else _round(
                            float(document_header.overCost) * (detail.value / document_header.subtotal),
                            self.round_decimals)
                        self.discount2 = 0 if document_header.subtotal == 0 else _round(
                ...
                if self.total_records > 0:
                    ...
                    for detail in document_details:
                        ...
                        # Diferidos
                        self.ret_value.append(self.purchase_deferred(document_header=document_header,
                                                                     document_detail=detail,
                                                                     decimal_value=(
                                                                     detail.value + self.overcost - self.discount),
                                                                     account_type='D'))
                ...
                if self.total_records > 0:
                    ...
                    for detail in document_details:
                        ...
                        # Inversiones
                        self.ret_value.append(self.purchase_investment(document_header=document_header,
                                                                       document_detail=detail,
                                                                       decimal_value=(
                                                                       detail.value + self.overcost - self.discount),
                                                                       account_type='D'))
    ...
    def purchase_deferred(self, document_header, document_detail, decimal_value, account_type=None):
        accounting_record = AccountingRecord()
        # Encabezado
        accounting_record.branchId = document_header.branchId
        accounting_record.accountingDate = document_header.documentDate
        ...
        if document_detail.provider:
            ...
            accounting_record.allThirdId = document_detail.providerId
            accounting_record.allThirdType = "PR"
        ...
        if account_type == "D":
            ...
            accounting_record.balance = float(decimal_value)
        else:
    ...
    def purchase_investment(self, document_header=None, document_detail=None, decimal_value=None,
    ...
    def provider_advance(self, document_header, account_type=None):
        accounting_record = AccountingRecord()
        # Encabezado
        accounting_record.branch = document_header.branch
        accounting_record.accountingDate = document_header.documentDate

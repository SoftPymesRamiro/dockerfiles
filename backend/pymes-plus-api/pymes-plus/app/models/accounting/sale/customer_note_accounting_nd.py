...
class CustomerNoteAccountingND(object):
        ...
        try:
            ...
            if self.total_records > 0:
                ...
                for detail in document_details:
                    ...
                    if document_header.sourceDocumentHeader.source.shortWord == 'FS' and (
                            detail.comments is not None and detail.comments != ''):
                        self.ret_value.append(
                            self.sales_income_concept(document_header, detail, self.round_decimals, "C"))
                    ...
                    if detail.icaPercent and detail.icaPercent > 0 and detail.value > 0:
                        ...
                        self.ret_value.append(
                            self.sales_ica_expense(document_header, detail, self.round_decimals, 'D'))
            ...
            self.ret_value.append(self.customer_receivable(document_header=document_header, credit_debit='D'))
        ...
        if account_type == "C":
            accounting_record.credit = _round(document_detail.value -
                                              _round(document_detail.value *
                                                     float(document_detail.disccount) / 100, round_decimals),
                                              round_decimals)
        else:

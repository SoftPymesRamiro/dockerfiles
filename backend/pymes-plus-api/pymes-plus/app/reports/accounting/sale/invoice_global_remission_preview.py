...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_footer_n_header(self, page_count):
        ...
        :return:
        """
        preview_data = invoiceGlobalRemissionPreview.preview_data
        ...
        def footer(cnv):
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                data_footer_observations = [
                    [
                        Paragraph(par_observations, style_observaciones_extra),
                    ]
                ]
            ...
            #con mes
                ...
                text_change = 'Autorización Numeración de Facturación ' \
                              'N° {0} de {1} desde {2} {3} hasta {4} {5} con ' \
            ...
            #habilitada
                ...
                text_change = 'Numeración Habilitada por la DIAN según la Resolución N° {0} de {1} desde' \
                              ' {2} {3} hasta {4} {5}'.format(
                                                        preview_data['resolution'],
                                                        preview_data['resolution_date'],
                                                        preview_data['prefix_resolution'],
                                                        preview_data['consecutive_from'],
                ...
                text_change = 'Habilitación con  Autorización Numeración de Facturación N° {0} de' \
                              ' {1} desde {2} {3} hasta {4} {5} ' \
        ...
        def header(cnv):
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                if preview_data['termDays'] > 1:
                    dias = 'Días'
                elif preview_data['termDays'] == 1:
                    dias = 'Día'
                else:
                    dias = ''
                table_header_date_validity = Table(
                    [
                        ...
                        [
                            ...
                            Paragraph('{0} {1}'.format(preview_data['termDays'], dias),
                                      style_p_header_date_validity_right)
                        ...
                        [
                            Paragraph('', style_p_header_extra_validity),
                            Paragraph('', style_p_header_date_validity_right)
                        ],
            ...
            style_p_descri_extra = ParagraphStyle('Normal')
            style_p_descri_extra.fontName = 'Arial'
            style_p_descri_extra.fontSize = 7
            style_p_descri_extra.leading = 7

            style_p_descri_extra_right = ParagraphStyle('Normal')
            style_p_descri_extra_right.fontName = 'Arial'
            style_p_descri_extra_right.fontSize = 7
            style_p_descri_extra_right.leading = 7
            style_p_descri_extra_right.alignment = TA_RIGHT
            ...
            if preview_data['currencyId'] != default_decimals.currencyId:
                ...
                table_header_description = Table(
                    [
                        [
                            Paragraph('', style_p_descri_extra),
                            Paragraph('<b>PRODUCT CODE</b>', style_p_descri_extra),
                            Paragraph('<b>ITEM N°/DESCRIPTION</b>', style_p_descri_extra),
                            Paragraph('<b>UOM</b>', style_p_descri_extra_right),
                            Paragraph('<b>QTY ORDERED</b>', style_p_descri_extra_right),
                            Paragraph('<b>UNIT PRICE</b>', style_p_descri_extra_right),
                            Paragraph('<b>EXTENDED PRICE</b>', style_p_descri_extra_right),
                        ]

                    ],
                    [2 * cm, 2.7 * cm, 4.03 * cm, 2.2 * cm, 2.8 * cm, 2.6 * cm, 3.266 * cm],
                    [0.4 * cm],
                ...
                table_header_description = Table(
                    [
                        [
                            Paragraph('<b>REMISIÓN</b>', style_p_descri_extra),
                            Paragraph('<b>COD PRODUCTO</b>', style_p_descri_extra),
                            Paragraph('<b>N°ARTICULO/DESCRIPCIÓN</b>', style_p_descri_extra),
                            Paragraph('<b>U DE M</b>', style_p_descri_extra_right),
                            Paragraph('<b>CANT ORDENADA</b>', style_p_descri_extra_right),
                            Paragraph('<b>VR UNITARIO</b>', style_p_descri_extra_right),
                            Paragraph('<b>VALOR</b>', style_p_descri_extra_right),
                        ]
...
class invoiceGlobalRemissionPreview:
    preview_data = None

    @staticmethod
    def make_preview_pdf(preview_data):
        invoiceGlobalRemissionPreview.preview_data = preview_data
        default_decimals = session.query(DefaultValue.quantityDecimals,
                                         DefaultValue.valueDecimals,
                                         DefaultValue.currencyId,
                                         DefaultValue.branchId,
        ...
        style_p_details_description.fontSize = 7
        style_p_details_description.leading = 7

        style_p_details_description_right = ParagraphStyle('Normal')
        style_p_details_description_right.fontName = 'Helvetica-Bold'
        style_p_details_description_right.fontSize = 7
        style_p_details_description_right.leading = 7
        ...
        if preview_data['currencyId'] == default_decimals.currencyId:
            table_details_description = Table(
                [
                    [
                        Paragraph('REMISIÓN', style_p_details_description),
                        Paragraph('CÓDIGO', style_p_details_description),
                        Paragraph('DESCRIPCIÓN', style_p_details_description),
                        Paragraph('UND', style_p_details_description),
                        Paragraph('Vr UNITARIO', style_p_details_description_right),
                        Paragraph('CANTIDAD', style_p_details_description_right),
                        Paragraph('%DSC', style_p_details_description_right),
                        Paragraph('%IVA', style_p_details_description_right),
                        Paragraph('%RTF', style_p_details_description_right),
                        Paragraph('VALOR', style_p_details_description_right),
                    ]

                ],
                [2 * cm, 2 * cm, 3.8 * cm, 1.1 * cm, 2 * cm, 2 * cm, 1.3 * cm, 1.2 * cm, 1.2 * cm, 3 * cm],
                [0.4 * cm],
        ...
        for dct_det in preview_data['document_details']:
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                data.append(
                    [
                        Paragraph('' if not dct_det.sourceDocumentDetail else
                                  dct_det.sourceDocumentDetail.documentHeader.documentNumber, style),
        ...
        if preview_data['currencyId'] == default_decimals.currencyId:
            doc.build(
                [table_details_header,
                 ...
                 table_header_raya,
                    Table(
                        data,
                        [2 * cm, 2.1 * cm, 3.8 * cm, 1.2 * cm, 1.7 * cm, 2.1 * cm,
                         1.2 * cm, 1.2 * cm, 1.2 * cm, 3 * cm],
                        style=table_style
                )],
            ...
            doc.build(
                [Table(
                    data,
                    [2 * cm, 2.8 * cm, 5.6 * cm, 1.6 * cm, 1.7 * cm, 2.6 * cm, 3.3 * cm],
                    style=table_style
                )],
                canvasmaker=NumberedCanvas
            )

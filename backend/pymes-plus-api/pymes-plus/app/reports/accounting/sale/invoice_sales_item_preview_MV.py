...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_footer_n_header(self, page_count):
        ...
        :return:
        """
        preview_data = SaleItemPreviewMV.preview_data
        ...
        style_p_header.fontSize = 8
        style_p_header.leading = 8
        ...
        style_p_sub_header.fontSize = 8
        style_p_sub_header.leading = 8
        ...
        style_p_sub_header_ica.fontSize = 8
        style_p_sub_header_ica.leading = 8
        ...
        style_p_header_date_validity.fontSize = 7.5
        ...
        def footer(cnv):
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                # linea total
                cnv.line(17.6 * cm, 15 * cm, 20.6 * cm, 15 * cm)
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                # Denota el contenor de la tabla
                table_footer_observations.wrap(4.233 * cm, 2 * cm)
                # Dibuja la tabla en las coordenadas indicadas
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                # Dibuja la tabla en las coordenadas indicadas
                table_footer_total_word.drawOn(cnv, 1 * cm, 3.5 * cm)
            ...
            if preview_data['type_resolution'] == 0 and preview_data['months'] == 0:
                text_change = 'Numeración Autorizada por la DIAN según la Resolución ' \
                    ...
                    preview_data['resolution_date'], preview_data['prefix_resolution'],
                    preview_data['consecutive_from'], preview_data['prefix_resolution'],
            ...
            information_doc2 = 'FACTURA IMPRESA POR COMPUTADOR (Art. 617 E.T y Decreto 1165/96 Art. 13) ' \
                               'El (los)comprador(es) la firma(n) en señal de aceptación y de haber recibido ' \
                               'real y materialmente la mercancia y/o el servicio ' \
                               '{0} ' \
                               '<b>{1}</b> - <b>{2}</b>'.format(text_change,
                                                                preview_data['company_web'],
                                                                preview_data['company_email'])
            ...
            if preview_data['currencyId'] != default_decimals.currencyId:
                ...
                data_footer_total_word = [
                    [
                        Paragraph(information_doc2, style_printed_invoice_footer_centred),
                    ]
                ]
                ...
                # Denota el contenor de la tabla
                table_footer_total_word.wrap(12.7 * cm, 1.3 * cm)
                # Dibuja la tabla en las coordenadas indicadas
                table_footer_total_word.drawOn(cnv, 1 * cm, 2.2 * cm)
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                table_footer_sing = Table(
                    ...
                    [4.233 * cm, 4.233 * cm],  # Ancho de las columnas
                    [1.2 * cm],
                ...
                type_doc_infor = Paragraph('***{0}***'.format(documento), style_p_footer_right)
                type_doc_infor.wrap(5 * cm, 0.5 * cm)
                type_doc_infor.drawOn(cnv, 15.6 * cm, 0.5 * cm)
                ...
                company_information = Paragraph('Contabilidad Pymes+ NIT 830.506.365-7 '
                                                'Teléfono: (572) 3828300 Cali. '\
                                                'www.softpymes.com.co<br/> ***ORIGINAL***',style_p_footer_centred)
        ...
        def header(cnv):
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                p_company_name = Paragraph('<b>{0}</b>'.format(
                    paragraph_over_flow_height(
                        ...
                        right_indent=2.8)),
                    style_p_header)
                p_company_name.width = 13.8 * cm
                par_frag = p_company_name.breakLines(width=13.8 * cm)

                # Verifica el tamaña de el primer parrafo, Si tiene mas de 1 renglon rederiza la tabla mas abajo
                draw_company_on_y = 11
                if len(par_frag.lines) >= 2:
                    draw_company_on_y = 10.6
                    ...
                    [
                        Paragraph('<b>NIT: {0}-{1} {2}</b>'.format(
                            paragraph_over_flow(
                                ...
                                width=13.8,
                                font_size=8,
                                leading=8), nit1[1], preview_data['regimen']),
                            style_p_header),
                    ],
                ...
                table_header_company.wrap(12.8 * cm, 3.6 * cm)
                table_header_company.drawOn(cnv, 4.3 * cm, draw_company_on_y * cm)

                # cnv.line(10.795 * cm, 14 * cm, 10.795 * cm, 1 * cm) #linea de medicion
            ...
            if default_decimals.currencyId == preview_data['currencyId']:
                ...
                paginate.drawOn(cnv, 17.5 * cm, 10.7 * cm)
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                table_header_provider = Table(
                    [
                        ...
                        [
                            Paragraph('<b>Pago</b>', style_p_header_provider),
                            Paragraph(paragraph_over_flow(text=preview_data['forma_pago'],
                                                          width=4.7,
                                                          font_size=8,
                                                          leading=8),
                                      style_p_header_provider),
                ...
                table_header_provider.wrap(12.7 * cm, 2 * cm)
                table_header_provider.drawOn(cnv, 1 * cm, 8.5 * cm)
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                table_header_date_validity = Table(
                    [
                        [
                            ...
                            Paragraph('<b>Orden N°</b>',
                                      style_p_header_date_validity),
                            Paragraph(preview_data['order_number'], style_p_header_date_validity),
                ...
                table_header_date_validity = Table(
                    [
                        [
                            Paragraph('<b>Invoice / Factura de Venta</b>', style_p_header_date_validity),
                        ...
                        [
                            Paragraph('<b>Invoice Date / Fecha de Factura</b>', style_p_header_date_validity),
                            Paragraph(preview_data['document_date'], style_p_header_date_validity_right)

                        ],
                        [
                            Paragraph('<b>Terms / Plazo</b>', style_p_header_date_validity),
                            Paragraph(term_value, style_p_header_date_validity_right)

                        ],
                        [
                            Paragraph('<b>Due / Fecha Vencimiento</b>', style_p_header_date_validity),
                            Paragraph(preview_data['date_finish'], style_p_header_date_validity_right)
                        ],
                        [
                            Paragraph('<b>Po Number / N° Orden de Compra</b>', style_p_header_date_validity),
                            Paragraph(preview_data['order_number'], style_p_header_date_validity_right)
                        ],
                        [
                            Paragraph('<b>Currency / Moneda</b>', style_p_header_date_validity),
                            Paragraph(text_currency_value.title(), style_p_header_date_validity_right)
                        ],
                        [
                            Paragraph('<b>Exchangerate / Tasa de Cambio</b>', style_p_header_date_validity),
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                table_header_description.drawOn(cnv, 1 * cm, 8.1 * cm)

                cnv.line(1 * cm, 8 * cm, 20.6 * cm, 8 * cm)  # Línea
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                table_header_order_no.wrap(7.54 * cm, 0.9 * cm)
                table_header_order_no.drawOn(cnv, 13.7 * cm, 9.6 * cm)
...
class SaleItemPreviewMV:
    preview_data = None

    @staticmethod
    def make_preview_pdf(preview_data):
        SaleItemPreviewMV.preview_data = preview_data
        default_decimals = session.query(DefaultValue.quantityDecimals,
                                         DefaultValue.valueDecimals,
                                         DefaultValue.currencyId,
                                         DefaultValue.branchId,
        ...
        for dct_det in preview_data['document_details']:
            ...
            if default_decimals.printDescription == 1 and default_decimals.descriptionFrom == 1:
                if dct_det.item.description is None:
                    ...
                    info_comment = ''
                    i = 0
                    for info in dct_det.item.description:
                        if i <= 80:
                            info_comment += info
                            i += 1
                    if default_decimals.currencyId == preview_data['currencyId']:
                        det_comment = '<br/><font size=6>{0}</font>'.format(info_comment)
                    else:
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                data.append(
                    [
                        ...
                        Paragraph('{:20,.{}f}'.format(_round(dct_det.quantity, default_decimals.quantityDecimals),
                                                      default_decimals.quantityDecimals), style=style_num),
                        Paragraph('{:20,.{}f}'.format(_round(dct_det.unitValue, 2), 2), style=style_num),
                        Paragraph('{:20,.{}f}'.format(_round(dct_det.value, default_decimals.valueDecimals),
                                                      default_decimals.valueDecimals), style=style_num)
                    ]
                )
        ...
        if preview_data['currencyId'] == default_decimals.currencyId:
            doc = BaseDocTemplate(outfilepath, pagesize=(21.59 * cm, 13.97 * cm))
        else:

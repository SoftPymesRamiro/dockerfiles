...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_footer_n_header(self, page_count):
        ...
        :return:
        """
        preview_data = SaleInvoiceThirdPartyPreviewM.preview_data
        ...
        def footer(cnv):
            ...
            information_doc = 'FACTURA IMPRESA POR COMPUTADOR (Art. 617 E.T y Decreto 1165/96 Art. 13) ' \
                                  '<br/>El (los)comprador(es) la firma(n) en señal de ' \
                              'aceptación y de haber recibido ' \
            ...
            information_doc2 = 'FACTURA IMPRESA POR COMPUTADOR (Art. 617 E.T y Decreto 1165/96 Art. 13) ' \
                                  'El (los)comprador(es) la firma(n) en señal de aceptación ' \
                               'y de haber recibido ' \
                                  'real y materialmente la mercancia y/o el servicio ' \
                                  '{0} ' \
        ...
        def header(cnv):
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                table_header_description = Table(
                    ...
                    # [3.266 * cm, 3.266 * cm, 3.266 * cm, 3.266 * cm, 3.266 * cm, 3.266 * cm],
...
class SaleInvoiceThirdPartyPreviewM:
    preview_data = None

    @staticmethod
    def make_preview_pdf(preview_data):
        SaleInvoiceThirdPartyPreviewM.preview_data = preview_data
        default_decimals = session.query(DefaultValue.quantityDecimals,
                                         DefaultValue.valueDecimals,
                                         DefaultValue.currencyId,
                                         DefaultValue.branchId,

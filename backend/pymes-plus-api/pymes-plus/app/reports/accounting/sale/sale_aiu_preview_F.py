...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_footer_n_header(self, page_count):
        ...
        :return:
        """
        preview_data = SaleAIUPreviewF.preview_data
        ...
        def footer(cnv):
            ...
            if page_count == self._pageNumber:
                ...
                iva_gruop = sorted(iva_list, key=lambda tup: 0 if tup[0] is None else tup[0])
                ic_gruop = sorted(ic_list, key=lambda tup: 0 if tup[0] is None else tup[0])
...
class SaleAIUPreviewF:
    preview_data = None

    @staticmethod
    def make_preview_pdf(preview_data):
        SaleAIUPreviewF.preview_data = preview_data
        default_decimals = session.query(DefaultValue.quantityDecimals,
                                         DefaultValue.valueDecimals,
                                         DefaultValue.currencyId,
                                         DefaultValue.branchId,

...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_footer_n_header(self, page_count):
        ...
        :return:
        """
        preview_data = SaleOrderPreview.preview_data
            ...
            table_details_description = Table(
                [
                    [
                        ...
                        Paragraph('' if preview_data['valorizar'] == '1' else '<b>Vr UNITARIO</b>',
                                  style_p_header_description_right),
                        Paragraph('<b>CANTIDAD</b>', style_p_header_description_right),
                        Paragraph('' if preview_data['valorizar'] == '1' else '<b>%DSC</b>',
                                  style_p_header_description_right),
                        Paragraph('' if preview_data['valorizar'] == '1' else '<b>%IVA</b>',
                                  style_p_header_description_right),
                        Paragraph('' if preview_data['valorizar'] == '1' else '<b>%RTF</b>',
                                  style_p_header_description_right),
                        Paragraph('' if preview_data['valorizar'] == '1' else '<b>VALOR</b>',
                                  style_p_header_description_right),
                    ]
...
class SaleOrderPreview:
    ...
    def make_preview_pdf(preview_data):
        SaleOrderPreview.preview_data = preview_data
        default_decimals = session.query(DefaultValue.quantityDecimals,
                                         DefaultValue.valueDecimals,
                                         DefaultValue.currencyId,
                                         DefaultValue.branchId,
            ...
            data.append(
                [
                    ...
                    Paragraph('' if preview_data['valorizar'] == '1'
                              else '{:20,.{}f}'.format(_round(dct_det.unitValue,
                                                              default_decimals.valueDecimals),
                    ...
                    Paragraph('' if preview_data['valorizar'] == '1'
                              ...
                              style=style_num),
                    Paragraph('' if preview_data['valorizar'] == '1'
                              else '{:20,.{}f}'.format(_round(dct_det.value,
                                                              default_decimals.valueDecimals),
                                                       default_decimals.valueDecimals), style=style_num)
                ]
            )

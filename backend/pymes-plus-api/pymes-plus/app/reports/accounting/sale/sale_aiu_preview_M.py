...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_footer_n_header(self, page_count):
        ...
        :return:
        """
        preview_data = SaleAIUPreviewM.preview_data
        ...
        def footer(cnv):
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                # Dibuja la tabla en las coordenadas indicadas
                table_footer_totaling.drawOn(cnv, 13.7 * cm, 14.5 * cm)
                # linea total
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                # Dibuja la tabla en las coordenadas indicadas
                table_footer_observations.drawOn(cnv, 1 * cm, 14.5 * cm)
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                # Dibuja la tabla en las coordenadas indicadas
                table_footer_total_word.drawOn(cnv, 1 * cm, 17 * cm)
            ...
            if preview_data['type_resolution'] == 0 and preview_data['months'] == 0:
                text_change = 'Numeración Autorizada por la DIAN según la Resolución N° {0} de {1} desde {2} {3} hasta {4} {5}'.format(
                        preview_data['resolution'], preview_data['resolution_date'], preview_data['prefix_resolution'],
            ...
            if preview_data['currencyId'] != default_decimals.currencyId:
                ...
                # Dibuja la tabla en las coordenadas indicadas
                table_footer_total_word.drawOn(cnv, 1 * cm, 15.7 * cm)
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                # Dibuja la tabla en las coordenadas indicadas
                table_footer_sing.drawOn(cnv, 5.233 * cm, 14.5 * cm)
                ...
                # Dibuja la tabla en las coordenadas indicadas
                company_information.drawOn(cnv, 1 * cm, 14.2 * cm)
                ...
                type_doc_infor.drawOn(cnv, 15.6 * cm, 14.2 * cm)
        ...
        def header(cnv):
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                table_header_provider = Table(
                    [
                        ...
                        [
                            ...
                            Paragraph(paragraph_over_flow(text=term_value,
                                                          width=4.7,
                                                          font_size=8,
                                                          leading=8),
                                      style_p_header_provider),
                ...
                table_header_provider.drawOn(cnv, 1 * cm, 21.88 * cm)
                ...
                table_header_provider = Table(
                    [
                        ...
                        [
                            Paragraph(paragraph_over_flow(text=preview_data['customer'],
                                                          width=9.3,
                                                          font_size=8,
                                                          leading=8),
                                      style_p_header_provider),
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                table_header_date_validity.drawOn(cnv, 13.7 * cm, 21.88 * cm)
                ...
                table_header_date_validity = Table(
                    [
                        ...
                        [
                            ...
                            Paragraph(preview_data['currency'], style_p_header_date_validity_right)
                        ],
                        [
                            Paragraph('<b>Exchangerate / Tasa de Cambio</b>', style_p_header_date_validity),
                            Paragraph('{:20,.{}f}'.format(_round(preview_data['exchangeRate'],
                                                                 default_decimals.valueDecimals),
                                                          default_decimals.valueDecimals), style_p_header_date_validity_right)
                        ]
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                table_header_description.drawOn(cnv, 1 * cm, 21.5 * cm)

                cnv.line(1 * cm, 21.4 * cm, 20.6 * cm, 21.4 * cm)  # Línea
                ...
                table_header_description.wrap(19.6 * cm, 0.4 * cm)
                table_header_description.drawOn(cnv, 1 * cm, 20.75 * cm)
                ...
                table_header_description.wrap(19.6 * cm, 0.4 * cm)
                table_header_description.drawOn(cnv, 1 * cm, 20.4 * cm)
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                table_header_order_no.drawOn(cnv, 13.7 * cm, 22.98 * cm)
...
class SaleAIUPreviewM:
    preview_data = None

    @staticmethod
    def make_preview_pdf(preview_data):
        SaleAIUPreviewM.preview_data = preview_data
        default_decimals = session.query(DefaultValue.quantityDecimals,
                                         DefaultValue.valueDecimals,
                                         DefaultValue.currencyId,
                                         DefaultValue.branchId) \
        ...
        for dct_det in preview_data['document_details']:
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                data.append(
                    [
                        Paragraph(dct_det.comments.capitalize(), style),

...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_footer_n_header(self, page_count):
        ...
        :return:
        """
        preview_data = SaleInvoiceThirdPartyCommissionPreview.preview_data
        ...
        table_style_header_date_validity2 = TableStyle(
            [
                ...
                # ('VALIGN', (0, 0), (-3, -1), 'TOP'),
                # ('VALIGN', (-2, 0), (-1, -1), 'MIDDLE'),
                # ('SPAN', (1, 2), (-1, -2)),  # span plazo
                # ('SPAN', (2, 3), (-1, -1)),  # span tasa de cambio
                # ('GRID', (0, 0), (-1, -1), 1, (0, 0, 0)),
            ]
        )
        ...
        def footer(cnv):
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                data_footer_totaling = [
                    ...
                    [
                        #autoretencion de renta es valueCree
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                observaciones = '<para><b>Notes/Observaciones:</b> {0} </para>'.format(preview_data['comments'].capitalize())
            ...
            if preview_data['type_resolution'] == 0 and preview_data['months'] == 0:
                text_change = 'Numeración Autorizada por la DIAN según la Resolución N° {0} de {1} desde {2} {3} hasta {4} {5}'.format(
                    ...
                    preview_data['consecutive_from'], preview_data['prefix_resolution'], preview_data['consecutive_to'])

            #con mes
            elif preview_data['type_resolution'] == 0 and preview_data['months'] > 0:
                consecutive_end = preview_data['consecutive_to'].lstrip("0")
                cant = len(consecutive_end)
                x = 0
                conseutive_ini = ''
                for num in preview_data['consecutive_from']:
                    if num == '0':
                        conseutive_ini = num * cant
                    else:
                        i = 9 - x
                        conseutive_ini += num[i]
                        if x <= cant:
                            x += 1

                text_change = 'Autorización Numeración de Facturación N° {0} de {1} desde {2} {3} hasta {4} {5} con ' \
                              'vigencia de {6} mes(es)'.format(preview_data['resolution'],
            ...
            #habilitada
                ...
                text_change = 'Numeración Habilitada por la DIAN según la Resolución N° {0} de {1} desde {2} {3} hasta {4} {5}'.format(
                ...
                text_change = 'Habilitación con  Autorización Numeración de Facturación N° {0} de {1} desde {2} {3} hasta {4} {5} ' \
                              'con vigencia de {6} Mes(es)'.format(preview_data['resolution'],
                                                                   preview_data['resolution_date'],
                                                                   preview_data['prefix_resolution'],
                                                                   conseutive_ini,
                                                                   preview_data['prefix_resolution'],
            ...
            #
            # provider_signature_p = Paragraph('Proveedor <br/> Firma y Sello', style_p_footer_centred)
            #
            # # Denota el contenor de la tabla
            ...
            #
            # company_signature_p = Paragraph('Empresa <br/> Firma y Sello', style_p_footer_centred)
            #
            # # Denota el contenor de la tabla
        ...
        def header(cnv):
                ...
                table_header_date_validity = Table(
                    [
                        ...
                        [
                            ...
                            Paragraph('<b>Orden N°</b>', style_p_header_date_validity),
                ...
                table_header_date_validity = Table(
                    [
                        [
                            ...
                            Paragraph('N°{0}'.format(preview_data['consecutive']), style_p_header_date_validity)
           ...
           # INFORMACION DE LA TABLA ORDEN DE COMPRA No --------------------------------------------------------------
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                consecutive = preview_data['consecutive'].lstrip("0")
...
class SaleInvoiceThirdPartyCommissionPreview:
    preview_data = None

    @staticmethod
    def make_preview_pdf(preview_data):
        SaleInvoiceThirdPartyCommissionPreview.preview_data = preview_data
        default_decimals = session.query(DefaultValue.quantityDecimals,
                                         DefaultValue.valueDecimals,
                                         DefaultValue.currencyId,
                                         DefaultValue.branchId,
        ...
        style_p_details_description.fontName = 'Arial'
        ...
        style_p_details_description_right.fontName = 'Arial'

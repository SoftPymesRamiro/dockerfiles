...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_footer_n_header(self, page_count):
        ...
        :return:
        """
        preview_data = InvoiceProfessionalServicesPreviewM.preview_data
        ...
        style_printed_invoice_footer_centred.leading = 7
        style_printed_invoice_footer_centred.alignment = TA_CENTER

        style_printed_extra_centred = ParagraphStyle('Normal')
        style_printed_extra_centred.fontName = 'Arial'
        style_printed_extra_centred.fontSize = 6.5
        style_printed_extra_centred.leading = 6.8
        style_printed_extra_centred.alignment = TA_CENTER
        ...
        def footer(cnv):
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                # Dibuja la tabla en las coordenadas indicadas
                table_footer_totaling.drawOn(cnv, 13.7 * cm, 14.9 * cm)
                # linea total
                cnv.line(17.6 * cm, 15.4 * cm, 20.6 * cm, 15.4 * cm)
                ...
                table_footer_totaling = Table(
                    data_footer_totaling,  # Contenido de la tabla
                    [9.7 * cm, 3 * cm],  # Ancho de las columnas
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                # Dibuja la tabla en las coordenadas indicadas
                table_footer_observations.drawOn(cnv, 1 * cm, 14.9 * cm)
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                # Dibuja la tabla en las coordenadas indicadas
                table_footer_total_word.drawOn(cnv, 1 * cm, 17.2 * cm)
            ...
            if preview_data['currencyId'] != default_decimals.currencyId:
                ...
                data_footer_total_word = [
                    [
                        Paragraph(information_doc2, style_printed_extra_centred),
                    ]
                ]
                ...
                # Dibuja la tabla en las coordenadas indicadas
                table_footer_total_word.drawOn(cnv, 1 * cm, 16.1 * cm)
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                # Dibuja la tabla en las coordenadas indicadas
                table_footer_sing.drawOn(cnv, 5.233 * cm, 14.9 * cm)
                ...
                style_p_text_pymes = ParagraphStyle('Normal')
                style_p_text_pymes.fontName = 'Arial'
                style_p_text_pymes.fontSize = 6
                style_p_text_pymes.leading = 6
                style_p_text_pymes.alignment = TA_LEFT

                company_information = Paragraph('Contabilidad Pymes+ NIT 830.506.365-7 '
                                                'Teléfono: (572) 3828300 Cali. ' \
                                                'www.softpymes.com.co', style_p_text_pymes)
                ...
                style_p_text_document = ParagraphStyle('Normal')
                style_p_text_document.fontName = 'Arial'
                style_p_text_document.fontSize = 6
                style_p_text_document.leading = 6
                style_p_text_document.alignment = TA_RIGHT

                type_doc_infor = Paragraph('***{0}***'.format(documento), style_p_text_document)
...
class InvoiceProfessionalServicesPreviewM:
    preview_data = None

    @staticmethod
    def make_preview_pdf(preview_data):
        InvoiceProfessionalServicesPreviewM.preview_data = preview_data
        default_decimals = session.query(DefaultValue.quantityDecimals,
                                         DefaultValue.valueDecimals,
                                         DefaultValue.currencyId,
                                         DefaultValue.branchId,
        ...
        data = []
        style_comments = ParagraphStyle('Normal')
        style_comments.fontName = 'Arial'
        style_comments.fontSize = 8
        style_comments.leading = 9
        style_comments.alignment = TA_JUSTIFY
        ...
        for dct_det in preview_data['document_details']:
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                data.append(
                    [
                        Paragraph(dct_det.comments.capitalize(), style_comments),

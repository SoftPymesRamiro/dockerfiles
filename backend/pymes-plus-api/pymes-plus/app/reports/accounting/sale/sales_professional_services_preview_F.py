...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_footer_n_header(self, page_count):
        ...
        :return:
        """
        preview_data = SalesProfessionalServicesPreviewF.preview_data
        ...
        def footer(cnv):
            ...
            data_footer_totaling = [
                ...
                [
                    Paragraph('<b>NETO COTIZACIÓN</b>', style_p_footer),
                    Paragraph('', style_p_footer_right),
            ...
            table_footer_totaling = Table(
                ...
                [2.86 * cm, 1.1 * cm, 2.57 * cm],  # Ancho de las columnas
...
class SalesProfessionalServicesPreviewF:
    preview_data = None

    @staticmethod
    def make_preview_pdf(preview_data):
        SalesProfessionalServicesPreviewF.preview_data = preview_data
        default_decimals = session.query(DefaultValue.quantityDecimals,
                                         DefaultValue.valueDecimals,
                                         DefaultValue.branchId,
                                         DefaultValue.currencyId) \

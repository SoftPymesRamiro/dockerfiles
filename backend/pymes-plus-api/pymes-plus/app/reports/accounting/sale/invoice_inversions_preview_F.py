...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_footer_n_header(self, page_count):
        ...
        :return:
        """
        preview_data = InvoiceInversionsPreview_F.preview_data
        ...
        def footer(cnv):
            ...
            par_total_word = paragraph_over_flow_height(text=tot_word, width=12.4, no_par=3, font_size=8, leading=8)
...
class InvoiceInversionsPreview_F:
    preview_data = None

    @staticmethod
    def make_preview_pdf(preview_data):
        InvoiceInversionsPreview_F.preview_data = preview_data
        default_decimals = session.query(DefaultValue.quantityDecimals,
                                         DefaultValue.valueDecimals,
                                         DefaultValue.currencyId,
                                         DefaultValue.branchId,
        ...
        if preview_data['currencyId'] == default_decimals.currencyId:
            table_details_description = Table(
                [
                    [
                        Paragraph('NOMBRE', style_p_details_description),
                        Paragraph('DOCUMENTO', style_p_details_description),

...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_footer_n_header(self, page_count):
        ...
        :return:
        """
        preview_data = InvoiceInversionsPreview_M.preview_data
        ...
        def footer(cnv):
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                # Dibuja la tabla en las coordenadas indicadas
                table_footer_totaling.drawOn(cnv, 13.7 * cm, 15 * cm)
                # linea total
                cnv.line(17.6 * cm, 15.5 * cm, 20.6 * cm, 15.5 * cm)
                ...
                data_footer_totaling = [
                    ...
                    [
                        ...
                        # Paragraph('100,000,000,000.00', style_p_footer_right),
                        Paragraph('<b>${:20,.{}f}</b>'.format(_round(neto_a_pagar, default_decimals.valueDecimals),
                                                       default_decimals.valueDecimals), style_p_footer_right)
                    ]
                ]
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                # Dibuja la tabla en las coordenadas indicadas
                table_footer_observations.drawOn(cnv, 1 * cm, 15 * cm)
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                # Dibuja la tabla en las coordenadas indicadas
                table_footer_total_word.drawOn(cnv, 1 * cm, 17.5 * cm)
            ...
            if preview_data['currencyId'] != default_decimals.currencyId:
                ...
                # Dibuja la tabla en las coordenadas indicadas
                table_footer_total_word.drawOn(cnv, 1 * cm, 16.2 * cm)
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                ...
                # Dibuja la tabla en las coordenadas indicadas
                table_footer_sing.drawOn(cnv, 5.233 * cm, 15 * cm)
                ...
                # Dibuja la tabla en las coordenadas indicadas
                company_information.drawOn(cnv, 1 * cm, 14.7 * cm)
                ...
                type_doc_infor.drawOn(cnv, 15.6 * cm, 14.7 * cm)
        ...
        def header(cnv):
                ...
                table_header_provider = Table(
                    [
                        ...
                        [
                            ...
                            Paragraph(paragraph_over_flow(text=preview_data['forma_pago'].upper(),
                                                          width=5,
                                                          font_size=8,
                                                          leading=8),
                                      style_p_header_provider),
            ...
            if preview_data['currencyId'] == default_decimals.currencyId:
                table_header_description = Table(
                    [
                        [
                            Paragraph('NOMBRE', style_p_header_provider),
                            Paragraph('DOCUMENTO N°', style_p_header_provider),
                            Paragraph('CANTIDAD', style_p_header_description_right),
                            Paragraph('VALOR', style_p_header_description_right),
                        ]
                ...
                table_header_description = Table(
                    [
                        [
                            ...
                            Paragraph('<b>DOCUMENTO N°</b>', style_p_header_provider),
...
class InvoiceInversionsPreview_M:
    preview_data = None

    @staticmethod
    def make_preview_pdf(preview_data):
        InvoiceInversionsPreview_M.preview_data = preview_data
        default_decimals = session.query(DefaultValue.quantityDecimals,
                                         DefaultValue.valueDecimals,
                                         DefaultValue.currencyId,
                                         DefaultValue.branchId,

...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_footer_n_header(self, page_count):
        ...
        :return:
        """
        preview_data = InventaryAdjustPreview.preview_data
        ...
        def header(cnv):
            ...
            table_header_date_validity = Table(
                [
                    ...
                    [
                        ...
                        Paragraph('<b>AJUSTE N° </b>', style_p_header_date_validity),
                    ...
                    [
                        ...
                        Paragraph('<b>Dependencia</b>', style_p_header_date_validity),
                        Paragraph(preview_data['dependency'], style_p_header_date_validity),
                    ],
                    [
                        Paragraph('<b>Tipo de Ajuste</b>', style_p_header_date_validity),
                        Paragraph(preview_data['import_puc_name'], style_p_header_date_validity),
                        '',
                        ''
                    ]
            ...
            table_header_description = Table(
                ...
                [1.8 * cm, 8 * cm, 1.4 * cm, 2.1 * cm, 2.6 * cm, 3.7 * cm],
                [0.4 * cm],
...
class InventaryAdjustPreview:
    preview_data = None

    @staticmethod
    def make_preview_pdf(preview_data):
        InventaryAdjustPreview.preview_data = preview_data
        default_decimals = session.query(DefaultValue.quantityDecimals,
                                         DefaultValue.valueDecimals,
                                         DefaultValue.branchId) \
            .filter(DefaultValue.branchId == preview_data['branch_id']).first()
        ...
        table_style_footer_total = TableStyle(
            [
                ...
                ('LINEABOVE', (1, 3), (3, 3), 1, (0, 0, 0)),  # linea horizontal
        ...
        doc.build(
            [Table(
                data,
                [1.9 * cm, 8 * cm, 1.3 * cm, 2.1 * cm, 2.6 * cm, 3.7 * cm],
                style=table_style

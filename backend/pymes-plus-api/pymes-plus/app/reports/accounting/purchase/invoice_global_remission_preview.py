    ...
    def draw_page_footer_n_header(self, page_count):
        ...
        def footer(cnv):
            ...
            table_footer_taxes = Table(
                ...
                # [4.3 * cm, 1.6 * cm, 1.7 * cm, 5.4 * cm],  # Ancho de las columnas
                [3 * cm, 2.6 * cm, 2 * cm, 3 * cm, 2.4 * cm],
            ...
            # Dibuja la tabla en las coordenadas indicadas
            table_footer_totaling.drawOn(cnv, 14 * cm, 1 * cm)

            # linea de medicion
            # cnv.line(14 * cm, 30 * cm, 14 * cm, 3 * cm) # //////////////////////////////////////////////////
        ...
        def header(cnv):
            ...
            #     _round(preview_data['exchangeRate'], default_decimals.valueDecimals)) \
            ...
            table_header_date_validity = Table(
                [
                    ...
                    [
                        ...
                        # Paragraph(paragraph_over_flow(text=text_currency_value, width=2.27, font_size=8, leading=8),
                        #           style_p_header_date_validity),

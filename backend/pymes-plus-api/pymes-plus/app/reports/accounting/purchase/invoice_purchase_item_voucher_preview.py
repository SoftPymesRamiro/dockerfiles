...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_footer_n_header(self, page_count):
        ...
        :return:
        """
        preview_data = InvoicePurchaseItemVoucherPreview.preview_data
        ...
        def footer(cnv):
            ...
            # ANULADO -------------------------------------------------------------------------------------------------
            # TODO: Descomentariar al traer los datos
...
class InvoicePurchaseItemVoucherPreview:
    preview_data = None

    @staticmethod
    def make_same_page_preview_pdf(preview_data):
        InvoicePurchaseItemVoucherPreview.preview_data = preview_data
    ...
    def number_to_text(value):
        ...
        if value == 0:
            ...
            num_to_text = 'DIECI{0}'.format(InvoicePurchaseItemVoucherPreview.number_to_text(value - 10))
        elif value == 20:
            num_to_text = 'VEINTE'
        elif value < 30:
            segunda_cifra = ''
            if value % 20 == 1:
                ...
                segunda_cifra = InvoicePurchaseItemVoucherPreview.number_to_text(value % 20)
            ...
            if value % 10 == 1:
                ...
                segunda_cifra = InvoicePurchaseItemVoucherPreview.number_to_text(value % 10)

            num_to_text = '{0} Y {1}'.format(InvoicePurchaseItemVoucherPreview.number_to_text(math.trunc(value / 10) * 10),
                                             segunda_cifra)

        elif value == 100:
            num_to_text = 'CIEN'
        elif value < 200:
            num_to_text = 'CIENTO {0}'.format(InvoicePurchaseItemVoucherPreview.number_to_text(value - 100))
        elif value == 200 or value == 300 or value == 400 or value == 600 or value == 800:
            num_to_text = '{0}CIENTOS'.format(InvoicePurchaseItemVoucherPreview.number_to_text(value / 100))
        elif value == 500:
            ...
            num_to_text = '{0} {1}'.format(InvoicePurchaseItemVoucherPreview.number_to_text(math.trunc(value / 100) * 100),
                                          InvoicePurchaseItemVoucherPreview.number_to_text(value % 100))
        elif value == 1000:
            num_to_text = 'MIL'
        elif value < 2000:
            num_to_text = 'MIL {0}'.format(InvoicePurchaseItemVoucherPreview.number_to_text(value % 1000))
        elif value < 1000000:
            num_to_text = '{0} MIL'.format(InvoicePurchaseItemVoucherPreview.number_to_text(value / 1000))
            if value % 1000 > 0:
                num_to_text = '{0} {1}'.format(num_to_text, InvoicePurchaseItemVoucherPreview.number_to_text(value % 1000))
        elif value == 1000000:
            num_to_text = 'UN MILLÓN'
        elif value < 2000000:
            num_to_text = 'UN MILLÓN {0}'.format(InvoicePurchaseItemVoucherPreview.number_to_text(value % 1000000))
        elif value < 1000000000000:
            num_to_text = '{0} MILLONES'.format(InvoicePurchaseItemVoucherPreview.number_to_text(math.trunc(value / 1000000)))
            if (value - math.trunc(value / 1000000) * 1000000) > 0:
                num_to_text = '{0} {1}'.format(num_to_text,
                                              InvoicePurchaseItemVoucherPreview.number_to_text(value - math.trunc(value / 1000000) * 1000000))
        elif value == 1000000000000:
            num_to_text = 'UN BILLÓN'
        elif value < 2000000000000:
            num_to_text = 'UN BILLÓN {0}'.format(InvoicePurchaseItemVoucherPreview.number_to_text(value - (math.trunc(value / 1000000000000) * 1000000000000)))
        else:
            num_to_text = '{0} BILLONES'.format(InvoicePurchaseItemVoucherPreview.number_to_text(math.trunc(value / 1000000000000)))
            if (value - math.trunc(value / 1000000000000) * 1000000000000) > 0:
                num_to_text = '{0} {1}'.format(num_to_text,
                                              InvoicePurchaseItemVoucherPreview.number_to_text(value - math.trunc(value / 1000000000000) * 1000000000000))
        return num_to_text
    ...
    def total_to_letter(total, currency, post_fijo_monto_letras):
        ...
        dec = 'CON {0}/100'.format(InvoicePurchaseItemVoucherPreview.fill_from_left(str(decimales), '0', 2))
        res = '{0} '.format(InvoicePurchaseItemVoucherPreview.number_to_text(Decimal(entero)))
        if not(entero == 0):
            if (entero % 1000000) == 0:
                res = '{0} DE '.format(res)

        res = '{0} {1} {2} {3}'.format(res, InvoicePurchaseItemVoucherPreview.get_currency(currency.upper()), dec, post_fijo_monto_letras.upper())
        return res

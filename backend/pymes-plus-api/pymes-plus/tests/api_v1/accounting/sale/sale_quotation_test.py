...
handled sale_quotations
"""
class SaleQuotationsTest(unittest.TestCase):
    """
    This Class is a  Test Case for sale_quotations API class
    """
    ...
    def request_get(self, data, path="/"):
        """Sent get request to #/api/v1/sale_quotations# with sale_quotations data values

        :param data: sale_quotations data
        :type data: json object, default none
        :param path: specific path
        :type path: str
        :return: request response in dict format
        """
        return self.test_client.get('/api/v1/sale_quotations' + path,
                                    data=json.dumps(data),
                                    content_type='application/json', headers=self.headers)  # envio el request


    def request_post(self, data, path="/"):
        """Sent post request to #/api/v1/sale_quotations# with sale_quotations data values
        ...
        :return: request response in dict format
        """
        return self.test_client.post('/api/v1/sale_quotations' + path,
                                     data=json.dumps(data),
                                     content_type='application/json', headers=self.headers)  # envio el request


    def request_put(self, data, path="/"):
        """Sent put request to #/api/v1/sale_quotations# with sale_quotations data values
        ...
        :return: request response in dict format
        """
        return self.test_client.put('/api/v1/sale_quotations' + path,
                                    data=json.dumps(data),
                                    content_type='application/json', headers=self.headers)  # envio el request


    def request_delete(self, data, path="/"):
        """Sent delete request to #/api/v1/sale_quotations# with sale_quotations data values
        ...
        :return: request response in dict format
        """
        return self.test_client.delete('/api/v1/sale_quotations' + path,
                                       data=json.dumps(data),
                                       content_type='application/json', headers=self.headers)  # envio el request
    ...
    def test_get_sale_quotations_search(self):
        """
        ...
        response.json = json.loads(response.data.decode("utf-8"))
        self.assertEquals(response.status_code, 200)
        sale_quotations = response.json

        # envio la peticion con short word que no existe
        response = self.request_get('', '/search?branch_id=14&short_word=XXXX&document_number=' + sale_quotations[
            'documentNumber'])
        ...
        response = self.request_get('',
                                    '/search?branch_id=14&short_word=FP&document_number=' + sale_quotations['documentNumber'])
        self.assertEquals(response.status_code, 200)
        response.json = json.loads(response.data.decode("utf-8"))
        ...
        # Peticion correcta
        response = self.request_get("", "/" + str(sale_quotations['documentHeaderId']))
        response.json = json.loads(response.data.decode("utf-8"))
        self.assertEquals(response.status_code, 200)
        ...
        # response = self.request_get("", "/" + str(sale_quotations['documentHeaderId']) + "/preview?format=P")
        # response.json = json.loads(response.data.decode("utf-8"))
        # self.assertEquals(response.status_code, 200)
        # self.assertNotEquals(response, {})
    ...
    def test_post_put_delete(self):
        ...
        sale_quotations["shortWord"] = None
        response = self.request_post(sale_quotations)
        response.json = json.loads(response.data.decode("utf-8"))
        self.assertNotEquals(response.json, {})
        ...
        sale_quotations["shortWord"] = "FP"
        # Crea un compra de item con un peso de diferencia en el credit
        sale_quotations['documentDetails'][0]['value'] = 550627.20
        response = self.request_post(sale_quotations)
        response.json = json.loads(response.data.decode("utf-8"))
        ...
        sale_quotations['documentDetails'][0]['value'] = 550627.18
        ...
        currency = sale_quotations['currency']
        ...
        sale_quotations["currency"] = currency2
        sale_quotations["currencyId"] = 2
        ...
        sale_quotations["currency"] = currency
        sale_quotations["currencyId"] = 4

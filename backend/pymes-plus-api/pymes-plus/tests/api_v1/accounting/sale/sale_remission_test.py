...
handled sale_remissions
"""
class SaleRemissionsTest(unittest.TestCase):
    """
    This Class is a  Test Case for sale_remissions API class
    """
    ...
    def request_get(self, data, path="/"):
        """Sent get request to #/api/v1/sale_remissions# with sale_remissions data values

        :param data: sale_remissions data
        :type data: json object, default none
        :param path: specific path
        :type path: str
        :return: request response in dict format
        """
        return self.test_client.get('/api/v1/sale_remissions' + path,
                                    data=json.dumps(data),
                                    content_type='application/json', headers=self.headers)  # envio el request


    def request_post(self, data, path="/"):
        """Sent post request to #/api/v1/sale_remissions# with sale_remissions data values
        ...
        :return: request response in dict format
        """
        return self.test_client.post('/api/v1/sale_remissions' + path,
                                     data=json.dumps(data),
                                     content_type='application/json', headers=self.headers)  # envio el request


    def request_put(self, data, path="/"):
        """Sent put request to #/api/v1/sale_remissions# with sale_remissions data values
        ...
        :return: request response in dict format
        """
        return self.test_client.put('/api/v1/sale_remissions' + path,
                                    data=json.dumps(data),
                                    content_type='application/json', headers=self.headers)  # envio el request


    def request_delete(self, data, path="/"):
        """Sent delete request to #/api/v1/sale_remissions# with sale_remissions data values
        ...
        :return: request response in dict format
        """
        return self.test_client.delete('/api/v1/sale_remissions' + path,
                                       data=json.dumps(data),
                                       content_type='application/json', headers=self.headers)  # envio el request
    ...
    def test_get_sale_remissions_search(self):
        """
        ...
        response.json = json.loads(response.data.decode("utf-8"))
        self.assertEquals(response.status_code, 200)
        sale_remissions = response.json

        # envio la peticion con short word que no existe
        response = self.request_get('', '/search?branch_id=14&short_word=XXXX&document_number=' + sale_remissions[
            'documentNumber'])
        ...
        response = self.request_get('',
                                    '/search?branch_id=14&short_word=FP&document_number=' + sale_remissions
                                        ['documentNumber'])
        self.assertEquals(response.status_code, 200)
        response.json = json.loads(response.data.decode("utf-8"))
        ...
        # Peticion correcta
        response = self.request_get("", "/" + str(sale_remissions['documentHeaderId']))
        response.json = json.loads(response.data.decode("utf-8"))
        self.assertEquals(response.status_code, 200)
        ...
        # response = self.request_get("", "/" + str(sale_remissions['documentHeaderId']) + "/preview?format=P")
        # response.json = json.loads(response.data.decode("utf-8"))
        # self.assertEquals(response.status_code, 200)
        # self.assertNotEquals(response, {})
    ...
    def test_post_put_delete(self):
        ...
        sale_remissions["shortWord"] = None
        response = self.request_post(sale_remissions)
        response.json = json.loads(response.data.decode("utf-8"))
        self.assertNotEquals(response.json, {})
        ...
        sale_remissions["shortWord"] = "FP"
        # Crea un compra de item con un peso de diferencia en el credit
        sale_remissions['documentDetails'][0]['value'] = 550627.20
        response = self.request_post(sale_remissions)
        response.json = json.loads(response.data.decode("utf-8"))
        ...
        sale_remissions['documentDetails'][0]['value'] = 550627.18
        ...
        currency = sale_remissions['currency']
        ...
        sale_remissions["currency"] = currency2
        sale_remissions["currencyId"] = 2
        ...
        sale_remissions["currency"] = currency
        sale_remissions["currencyId"] = 4
        ...
        self.assertEqual('PURCHASE ITEM NOT FOUND', response.json['message'].upper(),

...
handled advance_customer
"""
class SaleThirdPartyTest(unittest.TestCase):
    """
    This Class is a  Test Case for advance_customer API class
    """
    ...
    def request_get(self, data, path="/"):
        """Sent get request to #/api/v1/advance_customer# with advance_customer data values

        :param data: advance_customer data
        :type data: json object, default none
        :param path: specific path
        :type path: str
        :return: request response in dict format
        """
        return self.test_client.get('/api/v1/advance_customer' + path,
                                    data=json.dumps(data),
                                    content_type='application/json', headers=self.headers)  # envio el request


    def request_post(self, data, path="/"):
        """Sent post request to #/api/v1/advance_customer# with advance_customer data values
        ...
        :return: request response in dict format
        """
        return self.test_client.post('/api/v1/advance_customer' + path,
                                     data=json.dumps(data),
                                     content_type='application/json', headers=self.headers)  # envio el request


    def request_put(self, data, path="/"):
        """Sent put request to #/api/v1/advance_customer# with advance_customer data values
        ...
        :return: request response in dict format
        """
        return self.test_client.put('/api/v1/advance_customer' + path,
                                    data=json.dumps(data),
                                    content_type='application/json', headers=self.headers)  # envio el request


    def request_delete(self, data, path="/"):
        """Sent delete request to #/api/v1/advance_customer# with advance_customer data values
        ...
        :return: request response in dict format
        """
        return self.test_client.delete('/api/v1/advance_customer' + path,
                                       data=json.dumps(data),
                                       content_type='application/json', headers=self.headers)  # envio el request
    ...
    def test_get_advance_customer_search(self):
        """
        ...
        advance_customer = response.json

        # envio la peticion con short word que no existe
        response = self.request_get('', '/search?branch_id=14&short_word=XXXX&document_number=' + advance_customer[
            'documentNumber'])
        ...
        response = self.request_get('',
                                    '/search?branch_id=14&short_word=FP&document_number=' + advance_customer['documentNumber'])
        self.assertEquals(response.status_code, 200)
        response.json = json.loads(response.data.decode("utf-8"))
        ...
        # Peticion correcta
        response = self.request_get("", "/" + str(advance_customer['documentHeaderId']))
        response.json = json.loads(response.data.decode("utf-8"))
        self.assertEquals(response.status_code, 200)
        ...
        # response = self.request_get("", "/" + str(advance_customer['documentHeaderId']) + "/preview?format=P")
        # response.json = json.loads(response.data.decode("utf-8"))
        # self.assertEquals(response.status_code, 200)
        # self.assertNotEquals(response, {})
    ...
    def test_post_put_delete(self):
        ...
        advance_customer["shortWord"] = None
        response = self.request_post(advance_customer)
        response.json = json.loads(response.data.decode("utf-8"))
        self.assertNotEquals(response.json, {})
        ...
        advance_customer["shortWord"] = "FP"
        # Crea un compra de item con un peso de diferencia en el credit
        advance_customer['documentDetails'][0]['value'] = 550627
        response = self.request_post(advance_customer)
        response.json = json.loads(response.data.decode("utf-8"))
        ...
        advance_customer['documentDetails'][0]['value'] = 550627.18
        response = self.request_post(advance_customer)
        response.json = json.loads(response.data.decode("utf-8"))
        ...
        currency = advance_customer['currency']
        ...
        advance_customer["currency"] = currency2
        advance_customer["currencyId"] = 2
        ...
        advance_customer["currency"] = currency
        advance_customer["currencyId"] = 4

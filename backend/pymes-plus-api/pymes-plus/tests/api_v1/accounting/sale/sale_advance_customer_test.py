...
"""
class SaleAdvanceCustomerTest(unittest.TestCase):
    """
    ...
    def test_get_advance_customer_search(self):
        ...
        response.json = json.loads(response.data.decode("utf-8"))
        self.assertIn("data", response.json)
        advance_customer = response.json['data'][0]
        documentNumber = advance_customer['documentNumber']
        documentHeaderId = advance_customer['documentHeaderId']

...
handled inventary_adjust
"""
class InventoryAdjustTest(unittest.TestCase):
    """
    This Class is a  Test Case for inventary_adjust API class
    """
    ...
    def request_get(self, data, path="/"):
        """Sent get request to #/api/v1/inventary_adjust# with inventary_adjust data values

        :param data: inventary_adjust data
        :type data: json object, default none
        :param path: specific path
        :type path: str
        :return: request response in dict format
        """
        return self.test_client.get('/api/v1/inventary_adjust' + path,
                                    data=json.dumps(data),
                                    content_type='application/json', headers=self.headers)  # envio el request

    def request_post(self, data, path="/"):
        """Sent post request to #/api/v1/inventary_adjust# with inventary_adjust data values
        ...
        :return: request response in dict format
        """
        return self.test_client.post('/api/v1/inventary_adjust' + path,
                                     data=json.dumps(data),
                                     content_type='application/json', headers=self.headers)  # envio el request

    def request_put(self, data, path="/"):
        """Sent put request to #/api/v1/inventary_adjust# with inventary_adjust data values
        ...
        :return: request response in dict format
        """
        return self.test_client.put('/api/v1/inventary_adjust' + path,
                                    data=json.dumps(data),
                                    content_type='application/json', headers=self.headers)  # envio el request

    def request_delete(self, data, path="/"):
        """Sent delete request to #/api/v1/inventary_adjust# with inventary_adjust data values
        ...
        :return: request response in dict format
        """
        return self.test_client.delete('/api/v1/inventary_adjust' + path,
                                       data=json.dumps(data),
                                       content_type='application/json', headers=self.headers)  # envio el request
    ...
    def test_get_inventary_adjust_search(self):
        """
        ...
        response = self.request_get('', '/search?branch_id=1&short_word=AI&document_number=9999999999')
        ...
        response.json = json.loads(response.data.decode("utf-8"))
        self.assertIn("data", response.json)
        inventary_adjust = response.json['data'][0]
        documentNumber = inventary_adjust['documentNumber']
        documentHeaderId = inventary_adjust['documentHeaderId']
        ...
        # Peticion correcta
        response = self.request_get("", "/" + str(inventary_adjust['documentHeaderId']))
        response.json = json.loads(response.data.decode("utf-8"))
        self.assertEquals(response.status_code, 200)
        ...
        # response = self.request_get("", "/" + str(inventary_adjust['documentHeaderId']) + "/preview?format=P")
        # response.json = json.loads(response.data.decode("utf-8"))
        # self.assertEquals(response.status_code, 200)
        # self.assertNotEquals(response, {})
        # self.assertIn("data", response.json)
    ...
    #     inventary_adjust["shortWord"] = "FP"
    #     # Crea un compra de item con un peso de diferencia en el credit
    #     inventary_adjust['documentDetails'][0]['value'] = 550627
    #     response = self.request_post(inventary_adjust)
    #     response.json = json.loads(response.data.decode("utf-8"))
    #
    ...
    #     inventary_adjust['documentDetails'][0]['value'] = 550627.18
    #     response = self.request_post(inventary_adjust)
    #     response.json = json.loads(response.data.decode("utf-8"))
    #
    #     self.assertIn("documentNumber", response.json)
    ...
    #     currency = inventary_adjust['currency']
    ...
    #                   "symbol": "$"}
    #
    #     inventary_adjust["currency"] = currency2
    #     inventary_adjust["currencyId"] = 2
    ...
    #     inventary_adjust["currency"] = currency
    #     inventary_adjust["currencyId"] = 4
    #

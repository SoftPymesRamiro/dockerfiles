...
class InvoiceImportTest(unittest.TestCase):
    ...
    def request_get(self, data, path="/"):
        ...
        """
        return self.test_client.get('/api/v1/invoice_imports'+path,
    ...
    def request_post(self,data,path="/"):
        ...
        :return: request response in dict format
        """
        return self.test_client.post('/api/v1/invoice_imports'+path,
                data=json.dumps(data),
                content_type='application/json',headers=self.headers)  # envio el request
    ...
    def request_put(self,data,path="/"):
        ...
        :return: request response in dict format
        """
        return self.test_client.put('/api/v1/invoice_imports'+path,
                data=json.dumps(data),
                content_type='application/json',headers=self.headers)  # envio el request
    ...
    def request_delete(self,data,path="/"):
        ...
        :return: request response in dict format
        """
        return self.test_client.delete('/api/v1/invoice_imports'+path,
                data=json.dumps(data),
                content_type='application/json',headers=self.headers)  # envio el request
    ...
    def test_post_put_delete(self):
        ...
        self.assertEqual('INVOICE IMPORT NOT FOUND', response.json['message'].upper(),

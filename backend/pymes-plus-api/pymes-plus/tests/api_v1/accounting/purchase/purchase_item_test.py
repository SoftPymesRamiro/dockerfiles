...
handled purchase_item
"""
class PurchaseItemTest(unittest.TestCase):
    """
    This Class is a  Test Case for purchase_item API class
    """
    ...
    def request_get(self, data, path="/"):
        """Sent get request to #/api/v1/purchase_item# with purchase_item data values

        :param data: purchase_item data
        :type data: json object, default none
        :param path: specific path
        :type path: str
        :return: request response in dict format
        """
        return self.test_client.get('/api/v1/purchase_item' + path,
                                    data=json.dumps(data),
                                    content_type='application/json', headers=self.headers)  # envio el request


    def request_post(self, data, path="/"):
        """Sent post request to #/api/v1/purchase_item# with purchase_item data values
        ...
        :return: request response in dict format
        """
        return self.test_client.post('/api/v1/purchase_item' + path,
                                     data=json.dumps(data),
                                     content_type='application/json', headers=self.headers)  # envio el request


    def request_put(self, data, path="/"):
        """Sent put request to #/api/v1/purchase_item# with purchase_item data values
        ...
        :return: request response in dict format
        """
        return self.test_client.put('/api/v1/purchase_item' + path,
                                    data=json.dumps(data),
                                    content_type='application/json', headers=self.headers)  # envio el request


    def request_delete(self, data, path="/"):
        """Sent delete request to #/api/v1/purchase_item# with purchase_item data values
        ...
        :return: request response in dict format
        """
        return self.test_client.delete('/api/v1/purchase_item' + path,
                                       data=json.dumps(data),
                                       content_type='application/json', headers=self.headers)  # envio el request
    ...
    def test_get_purchase_item_search(self):
        ...
        response = self.request_get('',
                                    '/search?branch_id=14&short_word=FP&document_number=' + purchase_item['documentNumber'])
        self.assertEquals(response.status_code, 200)
        response.json = json.loads(response.data.decode("utf-8"))
    ...
    def test_post_put_delete(self):
        ...
        purchase_item["shortWord"] = "FP"
        # Crea un compra de item con un peso de diferencia en el credit
        purchase_item['documentDetails'][0]['value'] = 550627.20
        response = self.request_post(purchase_item)
        response.json = json.loads(response.data.decode("utf-8"))
        ...
        purchase_item['documentDetails'][0]['value'] = 550627.18
